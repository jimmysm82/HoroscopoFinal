...
public class Sagitario extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Bundle b = Sagitario.this.getIntent().getExtras();
        ...
        String fn = ""+nombre+" "+apellido+", nacido/a el "+fechaNacimiento+", corresponde al signo de Sagitario";
        ...
        volver.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(Sagitario.this, Home.class);
        ...
        BaseHelper bh = new BaseHelper(Sagitario.this, "prediccion", null, 1);
        ...
        try {
            if (c.moveToFirst()) {
                ...
                Toast.makeText(Sagitario.this, "No hay datos", Toast.LENGTH_SHORT).show();
            }
        }catch (Exception e){

            Toast.makeText(Sagitario.this, "Error :"+e.getMessage(), Toast.LENGTH_LONG).show();
