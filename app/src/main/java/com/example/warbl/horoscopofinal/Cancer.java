...
public class Cancer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Bundle b = Cancer.this.getIntent().getExtras();
        ...
        String fn = ""+nombre+" "+apellido+", nacido/a el "+fechaNacimiento+", corresponde al signo de Cancer";
        ...
        volver.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(Cancer.this, Home.class);
        ...
        BaseHelper bh = new BaseHelper(Cancer.this, "prediccion", null, 1);
        ...
        try {
            if (c.moveToFirst()) {
                ...
                Toast.makeText(Cancer.this, "No hay datos", Toast.LENGTH_SHORT).show();
            }
        }catch (Exception e){

            Toast.makeText(Cancer.this, "Error :"+e.getMessage(), Toast.LENGTH_LONG).show();
