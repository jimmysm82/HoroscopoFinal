...
public class Libra extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Bundle b = Libra.this.getIntent().getExtras();
        ...
        String fn = ""+nombre+" "+apellido+", nacido/a el "+fechaNacimiento+", corresponde al signo de Libra";
        ...
        volver.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(Libra.this, Home.class);
        ...
        BaseHelper bh = new BaseHelper(Libra.this, "prediccion", null, 1);
        ...
        try {
            if (c.moveToFirst()) {
                ...
                Toast.makeText(Libra.this, "No hay datos", Toast.LENGTH_SHORT).show();
            }
        }catch (Exception e){

            Toast.makeText(Libra.this, "Error :"+e.getMessage(), Toast.LENGTH_LONG).show();
