...
public class Geminis extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Bundle b = Geminis.this.getIntent().getExtras();
        ...
        String fn = ""+nombre+" "+apellido+", nacido/a el "+fechaNacimiento+", corresponde al signo de Geminis";
        ...
        volver.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(Geminis.this, Home.class);
        ...
        BaseHelper bh = new BaseHelper(Geminis.this, "prediccion", null, 1);
        ...
        try {
            if (c.moveToFirst()) {
                ...
                Toast.makeText(Geminis.this, "No hay datos", Toast.LENGTH_SHORT).show();
            }
        }catch (Exception e){

            Toast.makeText(Geminis.this, "Error :"+e.getMessage(), Toast.LENGTH_LONG).show();
