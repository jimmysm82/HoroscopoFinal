...
public class Piscis extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_piscis);
        ...
        Bundle b = Piscis.this.getIntent().getExtras();
        ...
        String fn = ""+nombre+" "+apellido+", nacido/a el "+fechaNacimiento+", corresponde al signo de Piscis";
        ...
        volver.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(Piscis.this, Home.class);
        ...
        BaseHelper bh = new BaseHelper(Piscis.this, "prediccion", null, 1);
        ...
        try {
            if (c.moveToFirst()) {
                ...
                Toast.makeText(Piscis.this, "No hay datos", Toast.LENGTH_SHORT).show();
            }
        }catch (Exception e){

            Toast.makeText(Piscis.this, "Error :"+e.getMessage(), Toast.LENGTH_LONG).show();
